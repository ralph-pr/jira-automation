...
def GetBacklistedUsers():
    user_name="SVC-account-for-devops"
    user_passwd="svc-user-password"
...
#con1 = pymssql.connect(host='10.77.169.168', port=1433, user='db-user',password='pwd-goes-here',database='confluence_odc_production')
con1 = pymssql.connect(host='oneconfluenceprodwest.cbhxxwrpq3pu.us-west-2.rds.amazonaws.com', port=1433, user='devopsdbadmin',password='YOURPWD',database='confluence_odc_production')
cur1 = con1.cursor()
...
def child ():
	...
	con2 = pymssql.connect(host='oneconfluenceprodwest.cbhxxwrpq3pu.us-west-2.rds.amazonaws.com', port=1433, user='devopsdbadmin',password='YOURPWD',database='Oneconfluence_prod_DBwest')
        cur2 = con2.cursor()
	...
	print('----------------Inserting Users into the CHILD Table Going on ----------------------------')
        for row in cur2:
			...
			#con3 = pymssql.connect(host='10.77.169.168', port=1433, user='db-user',password='pwd-goes-here',database='confluence_odc_production')
			con3 = pymssql.connect(host='oneconfluenceprodwest.cbhxxwrpq3pu.us-west-2.rds.amazonaws.com', port=1433, user='devopsdbadmin',password='YOURPWD',database='confluence_odc_production')
                        cur3 = con3.cursor()
...
def mastr ():
        #con4 = pyodbc.connect("DRIVER={ODBC Driver 13 for SQL Server};server=10.77.169.168;database=onestash_production_security_change;uid=db-user;pwd=pwd-goes-here")
	con4 = pymssql.connect(host='oneconfluenceprodwest.cbhxxwrpq3pu.us-west-2.rds.amazonaws.com', port=1433, user='devopsdbadmin',password='YOURPWD',database='confluence_odc_production')
        cur4 = con4.cursor()
...
def Notifyusers():
	...
	TOrecipients = ['sathish.kumar.devendran@example.com', 'balamurugan.thangamani@example.com', 'gordon.huang@example.com', 'deepa.tantry@example.com', 'sebastian.x.elayaraja@example.com', 'Madhu Babu Kandragula <madhu.babu.kandragula@example.com>','Suguna Elumalai <suguna.elumalai@example.com>','Sundareswaran Krishnan <sundareswaran.k@org.example.com>']
        #TOrecipients = ['sathish.kumar.devendran@example.com']
